 ...
 * 4) Zadeklaruj Liste Stringow, dodaj do niej kolekcje imion Tomek Ania Tomek Krzys Grzes Tomek metoda addAll, nastepnie usun wszystkich Tomkow z tej kolekcje.listy
 ...
 * 7) Zadeklaruj Liste zmiennych typu double, dodaj do kolekcje.listy 5 liczb rzeczywiste i wypisz je w kolejnosci rosnacej
 * 8) Napisz metode ktora uzupelnia losowa iloscia (od 2-8) liczb losowych z przedziaku 1-10, rzucmy te liczby do nowej kolekcje.listy posortujmy ja odwrotnie i zwracamy ta liste
 ...
 * 13) Napisz metode ktora dla kolekcje.listy intów zwroci roznice pomiedzy jej najwiekszym, a najmniejszym elementem
 ...
 * 17) Napisz metoda ktora sortuje kolekcje malejaco
 ...
 * 24) Napisz metode ktora przyjmuje jako parametr liste Stringow oraz liste intow (tej samej dlugosci obie kolekcje.listy)
 * 	   Metoda ma zwrocic liste Stringow z pirwszej kolekcje.listy ktorych dlugosc odpowiada liczbom na 2 liscie
